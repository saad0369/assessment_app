...
- Create Angular project with ng: `ng new assessmentapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`assessmentapp.client.esproj`).
